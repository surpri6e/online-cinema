      ...
      <div className="_Container">
        <div className="footer_body">
          ...
          <ul className="footer_social">
            <li><a href={INSTAGRAM_LINK}><img src={instagram} alt="instagram" /></a></li>
            <li><a href={TWITTER_LINK}><img src={twitter} alt="twitter" /></a></li>
            <li><a href={FACEBOOK_LINK}><img src={facebook} alt="facebook" /></a></li>
            <li><a href={TELEGRAM_LINK}><img src={telegram} alt="telegram" /></a></li>
          </ul>
