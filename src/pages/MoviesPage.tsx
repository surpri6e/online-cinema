            ...
            <div className='_Container'>
                <div className='fpw_body'>
                    ...
                    <FilmsPageBlock
                        ...
                        nextElementClass='next_element_movies_dramas'
                    />
                    <FilmsPageBlock
                        title='Adventures'
                        items={
                        ...
                        nextElementClass='next_element_movies_adventures'
                    />
                    <FilmsPageBlock
                        title='Melodramas'
                        items={
                        ...
                        nextElementClass='next_element_movies_melodramas'
                    />
                    <FilmsPageBlock
                        title='Comedias'
                        items={
                        ...
                        nextElementClass='next_element_movies_comedias'
                    />
                    <FilmsPageBlock
                        title='Fantastics'
                        items={
                        ...
                        nextElementClass='next_element_movies_fantastics'
                    />
                    <FilmsPageBlock
                        title='Trillers'
                        items={
                        ...
                        nextElementClass='next_element_movies_trillers'
                    />
                    <Thanks />
                </div>
            </div>
