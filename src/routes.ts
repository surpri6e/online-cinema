...
import { ALL_SEARCH_PATH, CARTOONS_PAGE_PATH, FILM_PAGE_PATH, LIKE_PAGE_PATH, LOOKED_PAGE_PATH, MAIN_PAGE_PATH, MOVIES_PAGE_PATH, REGISTRATION_PAGE_PATH, SERIES_PAGE_PATH, SUPPORT_PAGE_PATH, TOP_PAGE_PATH, YOU_PAGE_PATH } from './paths' 
